...
namespace Restaurant.UsersApp.Core.Application
{
    public class UserApplication : IUserApplication
    {
        ...
        public async Task<IEnumerable<RoleDto>> GetUserRole(UserDTO userDto)
        {
            var result = await _unitOfWork.UserRoleRepository.GetUserRole(s => new RoleDto
            {
        ...
        public async Task<PagenitionDto> GetUsers(PagenitionDto pg)
        {
